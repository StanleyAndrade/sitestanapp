function Pagaprocessamento () {
    return (
        <div className="divPaiAprovado">
            <img src="image/processamento.png" className="imagepag"></img>
            <h3>Sua compra está sendo processada!</h3>
            <p className="paragrafoPag">Assim que confirmada, seu site será feito.<br></br>
            Entre en contato com nossa equipe.</p>
            <p className="paragrafoPag">Ou espere um de nossos desenvolvedores entrar em contato com você no prazo de 24h!</p>
          ...
          <h3>Fale conosco</h3>
            ...
            <a href="https://www.instagram.com/buildev_/"><dt id='itemlistacontato'>Instagram</dt></a>
          </ul>
...
export default Pagaprocessamento;